 ...
 * @param[in] y Y coordinate.
 */
uint8_t gfy_GetPixel(uint24_t x, uint8_t y) GRAPHY_PURE;
 ...
 * @note By default, no text clipping is performed. See gfy_SetTextConfig.
 */
void gfy_PrintString(const char *string) GRAPHY_NONNULL(1);
 ...
 * @note By default, no text clipping is performed. See gfy_SetTextConfig.
 */
void gfy_PrintStringXY(const char *string, int24_t x, int24_t y) GRAPHY_NONNULL(1);

/**
 * @returns The current text cursor X position.
 */
int24_t gfy_GetTextX(void) GRAPHY_PURE;

/**
 * @returns The current text cursor Y position.
 */
int24_t gfy_GetTextY(void) GRAPHY_PURE;
 ...
 * @param[in] y Y coordinate.
 */
void gfy_Sprite(const gfy_sprite_t *sprite, int24_t x, int24_t y) GRAPHY_NONNULL(1);
 ...
 * @param[in] y Y coordinate.
 */
void gfy_Sprite_NoClip(const gfy_sprite_t *sprite, uint24_t x, uint8_t y) GRAPHY_NONNULL(1);
 ...
 * @param[in] y Y coordinate.
 */
void gfy_TransparentSprite(const gfy_sprite_t *sprite, int24_t x, int24_t y) GRAPHY_NONNULL(1);
 ...
 * @param[in] y Y coordinate.
 */
void gfy_TransparentSprite_NoClip(const gfy_sprite_t *sprite, uint24_t x, uint8_t y) GRAPHY_NONNULL(1);
 ...
 *       (width * height + 2) number of bytes.
 */
gfy_sprite_t *gfy_GetSprite(gfy_sprite_t *sprite_buffer, int24_t x, int24_t y) GRAPHY_NONNULL(1);
...
) GRAPHY_NONNULL(1, 2) GRAPHY_RETURNS_NONNULL;
 ...
 */
gfy_sprite_t *gfy_GetSpriteChar(char c) GRAPHY_RETURNS_NONNULL;
 ...
 */
uint8_t *gfy_SetFontData(const uint8_t *data) GRAPHY_RETURNS_NONNULL;
 ...
 */
void gfy_SetFontSpacing(const uint8_t *spacing) GRAPHY_NONNULL(1);
 ...
 */
uint24_t gfy_GetStringWidth(const char *string) GRAPHY_PURE GRAPHY_NONNULL(1);
 ...
 * @note Takes into account monospacing flag.
 */
uint24_t gfy_GetCharWidth(const char c) GRAPHY_PURE;
 ...
 */
bool gfy_GetClipRegion(gfy_region_t *region) GRAPHY_NONNULL(1);
...
gfy_sprite_t *gfy_ConvertFromRLETSprite(
    const gfy_rletsprite_t *__restrict sprite_in,
    gfy_sprite_t *__restrict sprite_out
) GRAPHY_NONNULL(1, 2) GRAPHY_RETURNS_NONNULL;
...
gfy_rletsprite_t *gfy_ConvertToRLETSprite(
    const gfy_sprite_t *__restrict sprite_in,
    gfy_rletsprite_t *__restrict sprite_out
) GRAPHY_NONNULL(1, 2) GRAPHY_RETURNS_NONNULL;
...
gfy_rletsprite_t *gfy_ConvertToNewRLETSprite(
    ...
    void *(*malloc_routine)(size_t)
) GRAPHY_ALLOCATOR GRAPHY_NONNULL(2);
