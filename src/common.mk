...
INSTALL_CXX03 := $(call QUOTE_ARG,$(call NATIVEPATH,$(INSTALL_DIR)/include/c++/__cxx03))
...
INSTALL_PSTL := $(call QUOTE_ARG,$(call NATIVEPATH,$(INSTALL_DIR)/include/c++/__pstl))
...
INSTALL_SUPPORT := $(call QUOTE_ARG,$(call NATIVEPATH,$(INSTALL_DIR)/include/c++/__support))
...
INSTALL_EXPERIMENTAL := $(call QUOTE_ARG,$(call NATIVEPATH,$(INSTALL_DIR)/include/c++/experimental))
INSTALL_EXT := $(call QUOTE_ARG,$(call NATIVEPATH,$(INSTALL_DIR)/include/c++/ext))
